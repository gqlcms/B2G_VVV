...
# with command line options: step2 --filein file:RAW.root --fileout file:AOD.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step RAW2DIGI,L1Reco,RECO,EI --nThreads 1 --era Run2_2016 --python_filename pset_aod.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 288
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step2 nevts:288'),
