...
# with command line options: step3 --filein AOD.root --fileout file:MINIAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 1 --era Run2_2016 --python_filename pset_miniaod.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1920
